"""
Django settings for jerrycan project.
...
MIDDLEWARE = [
    ...
    'prices.middleware.ForcePasswordChangeMiddleware',
]

ROOT_URLCONF = 'jerrycan.urls'
...
WSGI_APPLICATION = 'jerrycan.wsgi.application'
...
LOGGING = {
    ...
    # By default, only warnings and above from third-party libs.
    'root': {
        'handlers': ['console'],
        'level': 'WARNING',
    },
    'loggers': {
        # Our app: DEBUG and above → stdout (visible in docker logs)
        'prices': {
            'handlers': ['console'],
            'level': 'DEBUG',
            'propagate': False,
