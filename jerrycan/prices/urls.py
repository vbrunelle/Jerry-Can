...
urlpatterns = [
    ...
    path("analyses/transfer/<int:task_id>/", views.transfer_task_status, name="transfer_task_status"),
    path("analyses/transfer/<int:task_id>/cancel/", views.cancel_transfer_task, name="cancel_transfer_task"),
